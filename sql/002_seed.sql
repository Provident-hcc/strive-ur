...
INSERT INTO dbo.cadence_config (loc, payer, interval_days, submit_buffer, remind_ahead, p2p_window, appeal_window, initial_sla)
VALUES
...
INSERT INTO dbo.sla_cadence_config (loc, payer, interval_days, submit_buffer, remind_ahead, p2p_window, appeal_window, initial_sla)
VALUES
...
INSERT INTO dbo.coordinators (name, sort_order)
VALUES
    ('Meredith Dawson',    1),
    ('John Delahoyde',     2),
    ('Dusty Dawkins',      3),
...
INSERT INTO dbo.app_setup (setting_key, setting_value)
VALUES ('mode', 'live');
